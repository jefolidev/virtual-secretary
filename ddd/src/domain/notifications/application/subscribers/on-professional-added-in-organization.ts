...
import type { SendNotificationUseCase } from '@src/domain/notifications/application/use-cases/send-notification'
import { AddedProfessionalToOrganizationEvent } from '@src/domain/organization/enterprise/events/added-professional-organization'
