...
import { MarkAppointmentAsNoShowUseCase } from './mark-appointment-as-no-show'

let inMemoryAppointmentRepository: InMemoryAppointmentRepository
let inMemoryProfessionalRepository: InMemoryProfessionalRepository
let inMemoryClientRepository: InMemoryClientRepository
let sut: MarkAppointmentAsNoShowUseCase

describe('MarkAppointmentAsNoShow Appointment', () => {
  beforeEach(() => {
    inMemoryAppointmentRepository = new InMemoryAppointmentRepository()
    inMemoryProfessionalRepository = new InMemoryProfessionalRepository()
    inMemoryClientRepository = new InMemoryClientRepository()
    sut = new MarkAppointmentAsNoShowUseCase(
  ...
  it('should be able to mark an appointment as noshow', async () => {
  ...
  it('should not be able to mark an appointment as no show if professional not allowed', async () => {
    const client = makeClient({}, new UniqueEntityId('client-id'))
  ...
  it('should not be able to mark an appointment as no show if already completed', async () => {
    const client = makeClient({}, new UniqueEntityId('client-id'))
